    ...
    return /******/ (function(modules) { // webpackBootstrap
        ...
        ([
            ...
            function(module, exports, __webpack_require__) {
                ...
                var _publicLevelSelectorHtml = __webpack_require__(3);
                var _publicLevelSelectorHtml2 = _interopRequireDefault(_publicLevelSelectorHtml);
                ...
                var LevelSelector = (function(_UICorePlugin) {
                    ...
                    function LevelSelector() { _classCallCheck(this, LevelSelector);
                        _get(Object.getPrototypeOf(LevelSelector.prototype), 'constructor', this).apply(this, arguments); }
                    _createClass(LevelSelector, [{ key: 'bindEvents', value: function bindEvents() { this.listenTo(this.core, _clappr.Events.CORE_READY, this.bindPlaybackEvents);
                            ...
                            this.listenTo(this.core.mediaControl, _clappr.Events.MEDIACONTROL_HIDE, this.hideContextMenu); } }, { key: 'unBindEvents', value: function unBindEvents() { this.stopListening(this.core, _clappr.Events.CORE_READY);
                            ...
                            this.stopListening(this.core.getCurrentPlayback(), _clappr.Events.PLAYBACK_BITRATE); } }, { key: 'bindPlaybackEvents', value: function bindPlaybackEvents() { var currentPlayback = this.core.getCurrentPlayback();
                            this.listenTo(currentPlayback, _clappr.Events.PLAYBACK_PLAY, this.onPlay); } }, { key: 'reload', value: function reload() { this.unBindEvents();
                            this.bindEvents();
